...
{
	/// <summary>
	/// interface which inherit from IWaitable and use bool as result
	/// </summary>
	interface IWaitable : IWaitable<bool>
	{ }
	...
	/// <summary>
	/// interface which inherit from ICountWaitable and use bool as result
	/// </summary>
	interface ICountWaitable : ICountWaitable<bool>
	{ }
}